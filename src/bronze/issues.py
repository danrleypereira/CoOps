#!/usr/bin/env python3
"""
Issues and Pull Requests extraction for Bronze layer
Extracts raw issue/PR data from GitHub API
"""
...
def extract_issues(client: GitHubAPIClient, config: OrganizationConfig, use_cache: bool = True) -> List[str]:
    """Extract issues and pull requests to bronze layer"""
    ...
    for repo in filtered_repos[:5]:  # Limit to first 5 repos
